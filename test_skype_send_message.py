...
class SkypeSendTextMessageTest(unittest.TestCase):
    ...
    def test_send_text_message(self):
        ...
        print("id: " + self.id())
        self.assertEqual(skype_send_message.main("nexus12142", "nexus12141", "HELLO, TEST"), "HELLO, TEST")
 
    def test_messages_text_message(self):
        """MESSAGES"""
        print("id: " + self.id())
        self.assertEqual(skype_send_message.messages("nexus12142", "nexus12141", "HELLO, TEST"), "HELLO, TEST")
